...
<div className="parent  flex justify-center items-center ">
      ...
      {/* <div className="images flex justify-center items-center ">
        ...
        <img src={p[0].images[4]} alt="" style={{width:"100px"}} onClick={()=>{
          ...
          <h3 className="text-sm font-bold mt-2">Manufacturer Details</h3>
          ...
          <h3 className="text-sm font-bold mt-2">Customer Care Details</h3>
          ...
          <p className="text-gray-600">SUPERWELL COMTRADE PRIVATE LIMITED</p>
          ...
          <p className="text-gray-600">
            Haldiram's Classic Salted Peanuts, a classic combination of roasted
            peanuts with the right amount of salt. A perfect crunchy snack to
            binge on anytime of the day.
          </p>
       ...
       <p className='text-4xl font-bold'>{p.item}</p> 
          ...
          <div className="details flex justify-between items-center">
            ...
            <p className='text-base font-semibold '>{p.restaurant}</p>
              <span>MRP <p className="font-bold">₹{p.price} </p>
              <p>(Inclusive of all taxes)</p></span>
            </div>
            <div className="right">
            <button className='p-3 bg-[#32BCCC] text-white rounded-xl w-[134px] font-bold'
    onClick={()=>{
            ...
            <div className="box flex items-center justify-center gap-4">
              ...
              <div className="p-3">
                <div className="right-delivery m-2 ">
                  <div className="heading  text-black-600 text-sm">Superfast Delivery</div>
                ...
                <div className="right-price m-2 ">
                  <div className="heading text-black-600 text-sm">Best Prices & Offers</div>
                ...
                <div className="right-Assotment m-2">
                  <div className="heading text-black-600 text-sm">Wide Assortment</div>
                  <p className="text-black-600 text-sm">
